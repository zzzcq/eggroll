...
exchange_$party_id=$exchange_ip		  (the ip of exchange module,eg 127.xxx.xxx.xxx)
clustercomm_$party_id=$clustercomm_ip  (the ip of clustercomm module,eg 127.xxx.xxx.xxx)
metaservice_$party_id=$metaservice_ip  (the ip of metaservice module,eg 127.xxx.xxx.xxx)
proxy_$party_id=$proxy_ip			  (the ip of proxy module,eg 127.xxx.xxx.xxx)
roll_$party_id=$roll_ip				  (the ip of roll module,eg 127.xxx.xxx.xxx)
...
exchange_$partyA_id=$exchangeA_ip		(the ip of exchange module,eg 127.xxx.xxx.xxx)
clustercomm_$partyA_id=$clustercommA_ip  (the ip of clustercomm module,eg 127.xxx.xxx.xxx)
metaservice_$partyA_id=$metaserviceA_ip  (the ip of metaservice module,eg 127.xxx.xxx.xxx)
proxy_$partyA_id=$proxyA_ip				(the ip of proxy module,eg 127.xxx.xxx.xxx)
roll_$partyA_id=$rollA_ip				(the ip of roll module,eg 127.xxx.xxx.xxx)
...
exchange_$partyB_id=$exchangeB_ip		  (the ip of exchange module,eg 127.xxx.xxx.xxx)
clustercomm_$partyB_id=$clustercommB_ip   (the ip of clustercomm module,eg 127.xxx.xxx.xxx)
metaservice_$partyB_id=$metaserviceB_ip   (the ip of metaservice module,eg 127.xxx.xxx.xxx)
proxy_$partyB_id=$proxyB_ip			 	 (the ip of proxy module,eg 127.xxx.xxx.xxx)
roll_$partyB_id=$rollB_ip				 (the ip of roll module,eg 127.xxx.xxx.xxx)
...
ip=$server_ip					(the ip of single-node,eg 127.xxx.xxx.xxx)
exchange=$exchange_ip					(the ip of exchange module,eg 127.xxx.xxx.xxx)
